@mod @mod_peerassess
Feature: Test creating different types of peerassess questions for anonymous peerassess
  In order to create peerassesss
  As a teacher
  I need to be able to add different question types

  @javascript
  Scenario: Create different types of questions in anonymous peerassess with javascript enabled
    ...
    And I am on the "Learning experience" "peerassess activity" page
    And I navigate to "Analysis" in current page administration
