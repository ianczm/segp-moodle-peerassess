@mod @mod_peerassess
Feature: Anonymous peerassess
  In order to collect peerassesss
  As an admin
  I need to be able to allow anonymous peerassesss
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peerassess   | Site peerassess   | Acceptance test site | peerassess0 | 1         | 1             | 1       |
      | peerassess   | Course peerassess | C1                   | peerassess1 | 1         | 1             | 0       |
  ...
  Scenario: Guests can see anonymous peerassess on front page but can not complete
  ...
  Scenario: Complete anonymous peerassess on the front page as an authenticated user
  ...
  @javascript
  Scenario: Complete anonymous peerassess and view analysis on the front page as an authenticated user
  ...
  Scenario: Complete fully anonymous peerassess on the front page as a guest
    Given the following config values are set as admin:
      | peerassess_allowfullanonymous | 1 |
    When I follow "Site peerassess"
    And I follow "Preview"
    And I should see "Do you like our site?"
    And I press "Continue"
  ...
  @javascript
  Scenario: Complete fully anonymous peerassess and view analyze on the front page as a guest
    Given the following config values are set as admin:
      | peerassess_allowfullanonymous | 1 |
    And I log in as "admin"
  ...
  @javascript
  Scenario: Anonymous peerassess in a course
    # Teacher can not
  ...
  Scenario: Collecting new non-anonymous peerassess from a previously anonymous peerassess activity
    When I am on the "Course peerassess" "peerassess activity" page logged in as teacher
    ...
    And I am on the "Course peerassess" "peerassess activity editing" page logged in as teacher
    And I set the following fields to these values:
        | Record user names | User's name will be logged and shown with answers |
    And I press "Save and display"
    And I log out
    # Now leave a non-anon peerassess as user1
    And I am on the "Course peerassess" "peerassess activity" page logged in as user1
    And I follow "Answer the questions"
    And I set the following fields to these values:
